      ...
      <div className="">
        ...
        <div className=" flex gap-5">
          ...
          <div className="text-md font-semibold text-[#424242]">
            <p className=" flex items-center gap-2"><IoLocationOutline  size={20}/> Year of Publication:{book.publishing_year}</p>
          </div>
        </div>
        <div className="text-md font-semibold text-[#707070] flex gap-10">
          <p className=" flex items-center gap-2"><IoPeopleOutline size={20}/>Publisher:
          {book.book_publisher}</p>
          <p className=" flex items-center gap-2"><TbPageBreak size={20}/>Pages:{book.book_pages}</p>
        </div>
        <div className="grid gap-2">
          ...
          <div className=" flex justify-between">
            ...
            <button className="bg-green-600  text-white text-lg px-3 py-1 rounded-2xl">View Details</button>
            </Link>
